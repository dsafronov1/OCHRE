...
"enthalpy_lut_file": "ct53-resin_h-T_data_83frac_48C-shift.csv",
}
...
dwelling_args = {
    'name': 'MyHousePCM',  # simulation name
    ...
    'hpxml_file': os.path.join(default_input_path, 'Input Files', 'golden_4occ_40gal_120V.xml'),
    #'hpxml_file': os.path.join(default_input_path, 'Input Files', 'sample_resstock_properties.xml'),
    'hpxml_schedule_file': os.path.join(default_input_path, 'Input Files', 'golden_4occ_40gal_120V_schedules.csv'),
